...
UPLOAD_FOLDER = r'C:\Users\saifk\PycharmProjects\covid\flask app\assets\images'
...
def uploaded_chest():
   ...
   resnet_chest = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\resnet_chest.h5')
   vgg_chest = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\vgg_chest.h5')
   inception_chest = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\inceptionv3_chest.h5')
   xception_chest = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\xception_chest.h5')

   image = cv2.imread(r'C:\Users\saifk\PycharmProjects\covid\flask app\assets\images\upload_chest.jpg') # read file
...
def uploaded_ct():
   ...
   resnet_ct = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\resnet_ct.h5')
   vgg_ct = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\vgg_ct.h5')
   inception_ct = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\inception_ct.h5')
   xception_ct = tf.keras.models.load_model(r'C:\Users\saifk\PycharmProjects\covid\models\xception_ct.h5')

   image = cv2.imread(r'C:\Users\saifk\PycharmProjects\covid\flask app\assets\images\upload_ct.jpg') # read file
   image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB) # arrange format as per keras
   image = cv2.resize(image,(224,224))
   image = np.array(image) / 255
   image = np.expand_dims(image, axis=0)
